		...
		if($count > 0){
			echo "
				<div class='alert alert-warning'>
						...
						<b>Product is already added into the cart Continue placing your orders..!</b>
				</div>
			";
		} else {
		...
		if (mysqli_num_rows($query) > 0) {
			...
			<form method="post" action="login_form.php">
				...
				<tfoot>
					...
					<tr>
						<td><a href="store.php" class="btn btn-warning"><i class="fa fa-angle-left"></i> Continue placing your orders</a></td>
